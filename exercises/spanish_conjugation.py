...
def conjugate(verb):
    ...
    if word[-2] == "a":
        ...
        l.append(ready_word + "o")
        l.append(ready_word + "as")
        l.append(ready_word + "a")
        l.append(ready_word + "amos")
        l.append(ready_word + "ais")
        l.append(ready_word + "an")
    
    elif word[-2] == "e":
        word.pop()
        word.pop()
        ready_word_2 ="".join(word)
        l.append(ready_word_2 + "o")
        l.append(ready_word_2 + "es")
        l.append(ready_word_2 + "e")
        l.append(ready_word_2 + "emos")
        l.append(ready_word_2 + "eis")
        l.append(ready_word_2 + "en")

    elif word[-2] == "i":
        word.pop()
        word.pop()
        ready_word_3 = "".join(word)
        l.append(ready_word_3 + "o")
        l.append(ready_word_3 + "es")
        l.append(ready_word_3 + "e")
        l.append(ready_word_3 + "imos")
        l.append(ready_word_3 + "is")
        l.append(ready_word_3 + "en")

    else:
        print(f"{verb} is not an infinitive")
